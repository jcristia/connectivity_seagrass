# an edited basemap file so that I can use my own coastline with Opendrift.
# at the time, Opendrift could not use a custom coastline

# I've thought of many other ways to do this so that I don't have to modify base files
# However, this remains the simplest option for the moment so that I can move on.
# Otherwise, I would need to add my own copy of this library and change the import statements in
# all the base files of opendrift. This could become a mess as I update opendrift in the future.
# I'll be saving a copy of this file with opendrift so that it is recognized and backed up
# but the file in mpl_toolkits is the one that is ran. I need to make sure they stay synced.
#
# Edits I've made:
# import ogr and osr
# modified the _readboundarydata so that it reads my shp file and not the gshhs data
# then I pretty much just had to comment out a few sections of _readboundarydata
# and a few other minor edits in that function
#
# to change the shapfile used for the coastline: refer to line ~1212
...
import _geoslib
import functools
import ogr # added by me
import osr # added by me
...
class Basemap(object):
    ...
    def _readboundarydata(self,name,as_polygons=False):
        ...
        try:
            ...
            # rest of this try added by me
            shp = r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\spatial\boundaries\coastline_hakai_less4000.shp'
            #shp = r'/home/jcristia/coastline/coastline_hakai_less4000.shp' #cluster version
        ...
        # for line in bdatmetafile:
            ...
            if b is not None:
                ...
                # b.shape = (npts,2)
                b2 = b.copy()
                self.b3 = b2.copy() # this if for checking
