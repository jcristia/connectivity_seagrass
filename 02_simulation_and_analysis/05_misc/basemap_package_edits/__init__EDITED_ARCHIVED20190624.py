# a copy of basemap __init__
# I've saved the original as __init__ORIGINAL
...
# in all the base files of opendrift. This could become a mess as I update opendrift in the future.
