...
# test sensitivity of particle locations to changes diffusion
...
o.set_config('drift:current_uncertainty', m_per_s)
o.set_config('general:coastline_action', 'previous')
#o.set_config('general:coastline_action', 'stranding')
o.set_config('drift:scheme', 'euler')

diff = ''.join(str(diffusion).split('.'))

o.run(end_time=reader_salish.start_time + timedelta(days=3), time_step=60, time_step_output=1800,
    outfile=r'C:\Users\jcristia\Documents\GIS\MSc_Projects\Hakai\scripts_dev_scratch\sensitivity_testing\diffusion\working_simulation\outputs/seagrass12particles_' + diff + '.nc', export_variables=["age_seconds", "land_binary_mask"])   
